...
<asp:Content ID="cphCuerpo" ContentPlaceHolderID="Cuerpo" runat="Server">
    <div class="row">
        <div class="col-md-12" style="padding-top:15px;margin-left:20%;">
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" Width="663px" OnRowDataBound="GridView1_RowDataBound">
                ...
                <Columns>
                    <asp:ImageField DataImageUrlField="UsuarioFoto" DataImageUrlFormatString="Imagenes/{0}" ControlStyle-Width="50" ControlStyle-Height="50"></asp:ImageField>
                    <asp:BoundField DataField="UsuarioNombreApellido" HeaderText="Nombre, Apellido" SortExpression="UsuarioNombreApellido" />
                    <asp:TemplateField>
                        <ItemTemplate>
